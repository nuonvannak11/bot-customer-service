...
const contacts = [
  ...
  },
  {
    ...
    username: "@it_office",
    avatar: "https://ui-avatars.com/api/?name=IT&background=6366f1&color=fff",
    time: "11:12 am",
  ...
  },
  {
    ...
    name: "Fresh News",
    username: "@freshnews",
    avatar: "https://ui-avatars.com/api/?name=FN&background=0ea5e9&color=fff",
    time: "10:47 am",
  ...
  },
  {
    ...
    username: "@ekor",
    avatar: "https://ui-avatars.com/api/?name=EK&background=fff&color=000",
    time: "8:48 am",
    ...
    <div className="flex w-full h-[calc(100vh-100px)] bg-[#17212b] overflow-hidden rounded-xl shadow-2xl border border-[#0e1621]">
      ...
      >
        <div className="shrink-0 px-3 py-3 gap-3 flex items-center">
          <div className="flex-1 bg-[#242f3d] h-40 rounded-full flex items-center px-4 transition-colors group focus-within:bg-[#242f3d] focus-within:border focus-within:border-[#3390ec] border border-transparent">
            <Search
              size={18}
