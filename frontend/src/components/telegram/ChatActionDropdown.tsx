    ...
    <DropdownMenu.Root onOpenChange={(open) => {
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          sideOffset={5}
          align="end"
          className="z-[100] min-w-[160px] bg-[#17212b] border border-black/20 rounded-lg shadow-xl p-1.5 origin-top-right will-change-transform"
        >
          <DropdownMenu.Item 
          ...
          >
            <SkipForward size={16} className="text-[#707579] group-hover:text-[#64b5ef]" />
            <span>Skip</span>
          </DropdownMenu.Item>
          <DropdownMenu.Item 
